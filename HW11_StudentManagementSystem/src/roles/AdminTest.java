...
class AdminTest {
    ...
    void addCourses() {
        ...
        ad.addCourses(str2, file, "029", "CIT001" );
        assertEquals(51, courses.size());
    }

    @Test
    void beforeAddCourse() {
        assertFalse(admin.beforeAddCourse("CIT590", file));
        assertTrue(admin.beforeAddCourse("CIT000", file));
    }
    ...
    void beforeAddStuId() {
        // exist
        assertFalse(admin.beforeAddStuId("001", file));
        // do not exist
        assertTrue(admin.beforeAddStuId("000", file));
    }

    @Test
    void beforeAddStuUsername() {
        // exist
        assertFalse(admin.beforeAddStuUsername("testStudent01", file));
        // do not exist
        assertTrue(admin.beforeAddStuUsername("testStudent00", file));
    }

    @Test
    void beforeAddProfId() {
        // exist
        assertFalse(admin.beforeAddProfId("029", file));
        // do not exist
        assertTrue(admin.beforeAddProfId("000", file));
